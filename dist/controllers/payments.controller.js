...
export const PaymentsController = {
    ...
    testMpesaCredentials: async (req, res) => {
        try {
    ...
    testTillConfiguration: async (req, res) => {
        try {
            const mpesaService = new MpesaService();
    ...
    callback: async (req, res) => {
        try {
            ...
            if (ResultCode !== 0) {
                ...
                console.log('Error meaning:', errorMeanings[ResultCode] || 'Unknown error code');
                console.log('=============================');
            }
            if (ResultCode === 0) {
                // Success
